...
export default class SuccessfulConvoTable extends React.Component {
  ...
  receivedData() {
    ...
    var nofilter =
      "http://localhost:4000/successfulconversationtablenofilter?bot=" +
      this.props.bot;

    var filter =
      "http://localhost:4000/successfulconversationtablefilter?bot=" +
      this.props.bot +
      "&date=" +
      date;
  ...
  render() {
    return (
      <div className="modaltable">
        ...
        <tr>
          <table className="tablesuccess" width="300px">
            <tr className="TableRow">
